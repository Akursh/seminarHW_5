...
//  Метод sortedPrint() сортирует и распечатывает данные по абонентам  
    static void sortedPrint(Map<String, ArrayList> map) {
        ...
        // Формирует стек, начиная с минимального количества номеров 
        ...
        // вывод пары в порядке ключей, находящихся в стеке
        String name;
            ...
            switch (st) {
                case "1": {
                    ...
                    if (abon.containsKey(name)) {
                        System.out.println("Фамилия введена повторно");
                        System.out.println();
                        break;
                    } else {
